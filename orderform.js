...
function init(){
	...
	if(checkCookie("username")) {
		...
		document.getElementById('nav').innerHTML = '<a href="/">Home </a><a href="/users">Users </a>' +
		'<a href="/registration.html">Register</a><a href="/login.html">Login</a>';
		document.getElementById('info').innerHTML = '<h2>Please login or register for an account to access the Order Form</h2>';
